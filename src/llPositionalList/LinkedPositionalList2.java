...
public class LinkedPositionalList2<E> implements PositionalList<E> {
	...
	private static class DNode<E> implements Position<E> { 
		...
		private LinkedPositionalList2<E> list;
		public E getElement() {
			return element;
		}
		public DNode(E element, DNode<E> prev, DNode<E> next, LinkedPositionalList2<E> list) {
		...
		public LinkedPositionalList2<E> getList() {
			return list;
		}
	}
	...
	public LinkedPositionalList2(PLIteratorMaker<E> iter) {
		header = new DNode<>(); 
		trailer = new DNode<>(); 
	...
	private class ElementIterator implements Iterator<E> { 
		Iterator<Position<E>> posIterator = iteratorMaker.makeIterator((PositionalList<E>) this); 
		@Override
		public boolean hasNext() {
	...
	private class ElementBackwardsIterator implements Iterator<E> { 
